...
Container(
    ...
    AppRoutes.push(context, Sellerinstantmessage());
          ...
          groupchat(
            ...
            index==0?'GroupA':index==1?'GroupB':index==2?'GroupC':index==3?'GroupD':'GroupA',
  ...
  Widget groupchat(String img,String name,String time,int msgnumber,String msg,int index){
    return Card(
          shape:
