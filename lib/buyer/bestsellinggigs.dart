...
class Bestsellinggigs extends StatefulWidget {
  @override
  _BestsellinggigsState createState() => _BestsellinggigsState();
}

class _BestsellinggigsState extends State<Bestsellinggigs> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      PreferredSize(
        ...
        child: AppBarClass(context, false, _scaffoldKey, 'BEST SELLING GIGS'),
        )
