...
int bodyselector=1;
  ...
  Widget build(BuildContext context){
    ...
    return Scaffold(
      ...
      :Container(height: 1,), key: _sellerscaffoldKey,
...
child: SellerAppBarClass(context,true, _sellerscaffoldKey , 'PAYMENT METHOD'),
        )
        ),
         drawer: SellerDrawer(),
...
twodotpart(),
  ...
  Widget midlepart(){
    ...
    InkWell(
      ...
      child: Image.asset('images/adnewcardplus.png',
      scale: 4,),
    ),
